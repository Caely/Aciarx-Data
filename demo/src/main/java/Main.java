...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(media_15.get_acumulado_dia(dia));
        System.out.println(media_15.get_numero_corridas_dia(dia));
        System.out.println(media_15.get_pon_dia(dia));
        System.out.println(media_15.get_poff_dia(dia));
        System.out.println(media_15.get_pon_extra_dia(dia));
        System.out.println(media_15.get_poff_extra_dia(dia));
        System.out.println(media_15.get_sucata(dia));
        System.out.println(media_15.get_rendimento_diario(dia));
        System.out.println(media_15.get_media_producao(dia));
